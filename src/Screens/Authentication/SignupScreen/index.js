  ...
  _renderProfileIcon = () => {
    return (
      <View style={styles.profilePicContainerStyle}>
        <Image
          source={
            this.state.userInfo.image != ''
              ? {uri: this.state.userInfo.image?.uri}
              : allImages.generalImages.placeHolder
          }
        ...
        >
          <Image
            source={allImages.transparentIcons.camera}
    ...
    return (
      <View style={styles.scrollViewStyle}>
        ...
        <Button onPress={this._onContinue} style={styles.btnStyle}>
          <TextSemiBold style={styles.btnText}>Continue</TextSemiBold>
        </Button>

        <RippleTouch
          onPress={() => this.props.navigation.navigate('LoginScreen')}
        >
          <TextSemiBold style={styles.login}>Back To Login</TextSemiBold>
        </RippleTouch>
      </View>
    );
  };
