...
class SearchScreen extends React.Component {
  ...
  _navigate = item => {
    ...
    this.props.navigation.push('PoemDetailScreen', {
      poem: item,
      fromSearch: true,
      makeApiCall: true,
    });
...
const mapDispatchToProps = dispatch => {
  return {
    getPoems: (keyword, success, error) =>
      dispatch(actions.getPoems(keyword, success, error)),
    getPoetPoems: (keyword, success, error) =>
      dispatch(actions.getPoetPoems(keyword, success, error)),
